...
public class ClienteForm extends javax.swing.JFrame {
     ...
     */
    public ClienteForm(Usuario user,Usuario comprador) throws IOException, FileNotFoundException, ClassNotFoundException {
        initComponents();
        this.setLocationRelativeTo(null); // VENTENA EN CENTRO DE LA PANTALLA
        this.carrito = new CarritoCompras(user,comprador);
